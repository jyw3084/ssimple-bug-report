	...
	return (
		<ProtectedRoute>
			...
			{isLoading ? <Loading /> : <div className="px-4 pt-24 pb-8 md:p-16 md:pt-12 gap-4 font-medium">
				<div className="mb-8">
					<Link href={'/admin/issues'} className="font-bold text-gray-400 hover:text-gray-500 transition-colors"><i className="fas fa-arrow-left"></i> Back</Link>
				</div>
				<div className="flex gap-4">
					<div className="w-2/3">
						...
						<div className="mb-4">
							<span className="text-gray-400">Received at: {reportData?.created_at && showDate(reportData?.created_at)}</span>
						</div>
						<div className="mb-4">
						...
						<div>
							...
							<div className="rounded-lg border p-4">{reportData?.device_info}</div>
						</div>
					</div>
